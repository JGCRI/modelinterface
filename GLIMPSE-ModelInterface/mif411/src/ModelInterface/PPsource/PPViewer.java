...
//*************************Interface Setup Functions***************************
  ...
  {
	// TODO: this "Preprocessor file" menuItem needs to be re-arranged to be under "Advanced" >> "Open Files",YD edits
    // YD commented lines 171-176 out  
	...
	// YD added lines 178-183 to re-arrange "Preprocessor File" to be under "Advanced" >> "Open Files"
	  JMenuItem menuItem = new JMenuItem("Preprocessor file");
  	  menuItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_P,
  				ActionEvent.ALT_MASK));
  	  menuItem.addActionListener(this);
